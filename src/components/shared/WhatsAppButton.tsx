...
export default function WhatsAppButton({ propertyName, propertyId, phone: propPhone, siteConfig }: WhatsAppButtonProps) {
  ...
  return (
    <a
      ...
      className={`fixed right-6 z-50 w-[60px] h-[60px] bg-[#25D366] hover:bg-[#1EBE57] text-[#0F1923] rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-[bottom,opacity,transform] duration-200 ${
