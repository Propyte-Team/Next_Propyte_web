...
export default function TerminosContent({ locale }: { locale: string }) {
  return (
    <>
      ...
      <p>{pickLang(locale, 'Information about properties, prices, ROI, occupancy, and market analyses is referential. Although we work with multiple verified data sources (market data, comparables, official records), the user must verify directly with the developer or seller before making decisions.', 'La información sobre propiedades, precios, ROI, ocupación y análisis de mercado es referencial. Aunque trabajamos con múltiples fuentes de datos verificadas (datos de mercado, comparables, registros oficiales), el usuario debe verificar directamente con el desarrollador o vendedor antes de tomar decisiones.')}</p>
      <p>
