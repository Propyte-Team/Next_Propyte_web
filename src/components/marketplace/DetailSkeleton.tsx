...
/**
 * Shared loading skeleton for development/[slug] and propiedades/[slug] detail pages.
 * Both routes have the same SSR shape: breadcrumbs, hero gallery, title strip,
 * 2-column body grid (content + sticky contact sidebar).
 */
