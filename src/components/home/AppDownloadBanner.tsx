  ...
  return (
    <section className="py-20 md:py-28 bg-white">
      <div className="max-w-[1280px] mx-auto px-4 md:px-6">
        <div className="relative bg-gradient-to-br from-propyte-dark-800 to-propyte-dark-900 rounded-2xl overflow-hidden">
          {/* Decorative blobs — brand cyan en dark */}
          <div className="absolute top-0 right-0 w-80 h-80 bg-propyte-brand/10 rounded-full -translate-y-1/2 translate-x-1/3 pointer-events-none" />
          <div className="absolute bottom-0 left-0 w-56 h-56 bg-propyte-brand/5 rounded-full translate-y-1/3 -translate-x-1/4 pointer-events-none" />

          <div className="relative flex flex-col items-center text-center gap-6 p-8 md:p-14">
            <span className="inline-block text-propyte-brand text-xs font-bold tracking-widest uppercase">
              {t('eyebrow')}
            </span>
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 h-12 px-7 bg-propyte-brand hover:bg-propyte-cyan-300 text-propyte-dark-900 font-bold rounded-[8px] transition-colors text-sm"
              >
