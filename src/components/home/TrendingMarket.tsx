...
export default function TrendingMarket() {
  ...
  const statCards = [
    ...
    { icon: DollarSign, value: stats.avgADR, format: (n: number) => `$${n.toLocaleString()}`, label: t('stat2Label'), color: 'text-teal-a11y' },
    { icon: BarChart3, value: stats.avgOccupancy, format: (n: number) => `${n}%`, label: t('stat3Label'), color: 'text-teal-a11y' },
    { icon: Building2, value: stats.totalListings, format: (n: number) => n.toLocaleString(), label: t('stat4Label'), color: 'text-navy' },
