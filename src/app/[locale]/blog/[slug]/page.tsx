    ...
    <>
      ...
      <div className="max-w-[800px] mx-auto px-4 md:px-6 py-8">
        ...
        <header className="mb-8">
          ...
          <h1 className="text-2xl md:text-4xl font-bold text-[#1A2F3F] leading-tight mb-4">
            {post.title}
          </h1>
          ...
          <div className="flex flex-wrap items-center gap-4 text-sm text-gray-600 pb-6 border-b border-gray-100">
            ...
            <div className="flex items-center gap-2">
              {post.author_image ? (
                ...
                <div className="w-8 h-8 rounded-full bg-[#1A2F3F] flex items-center justify-center text-white text-xs font-bold">
                  {post.author_name.charAt(0).toUpperCase()}
                </div>
              )}
              <span className="font-medium text-[#1A2F3F]">{post.author_name}</span>
            </div>
