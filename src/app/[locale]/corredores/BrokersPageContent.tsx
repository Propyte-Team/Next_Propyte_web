      ...
      <div className="relative max-w-[1280px] mx-auto px-4 md:px-6 py-20 md:py-28">
        <div className="max-w-3xl">
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4">
            ...
            <a
              href={`https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP_PHONE || '529844638032'}?text=Hola%2C%20me%20interesa%20el%20programa%20de%20corredores`}
              target="_blank"
    ...
    <section className="bg-propyte-brand">
      <div className="max-w-[1280px] mx-auto px-4 md:px-6 py-12 md:py-16 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a
            href="#registro"
            className="h-14 px-8 bg-white text-[#0E7490] font-bold text-base rounded-xl hover:bg-gray-50 transition-all flex items-center justify-center gap-2"
          >
