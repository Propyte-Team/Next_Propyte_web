...
export default function UnitFAQs({ locale, unitName, city, price, downPaymentMin }: UnitFAQsProps) {
  ...
  const faqs = isEn
    ? [
        ...
        { q: 'Can I use this unit as a vacation rental (Airbnb)?', a: `Yes. ${city} is one of Mexico's top short-term rental markets. Units in this development are licensed for vacation rental and typically achieve 65-85% occupancy with AirDNA-backed ADR estimates.` },
        ...
        { q: 'Is the projected ROI guaranteed?', a: 'No. ROI projections are estimates based on historical data, AirDNA market benchmarks, and comparable rental analysis. Actual returns vary with occupancy, maintenance, and market conditions. Our calculator above lets you adjust assumptions.' },
      ]
    : [
        ...
        { q: '¿Puedo usar esta unidad para renta vacacional (Airbnb)?', a: `Sí. ${city} es uno de los mercados top de renta corta en México. Las unidades de este desarrollo están autorizadas para renta vacacional y típicamente logran ocupación del 65-85% con estimaciones de ADR basadas en datos AirDNA.` },
        ...
        { q: '¿El ROI proyectado es garantizado?', a: 'No. Las proyecciones de ROI son estimaciones basadas en datos históricos, benchmarks AirDNA del mercado y análisis de comparables de renta. Los rendimientos reales varían con la ocupación, mantenimiento y condiciones de mercado. La calculadora arriba te permite ajustar los supuestos.' },
      ];
        ...
        {faqs.map((f, i) => (
          ...
          >
            <summary className="cursor-pointer list-none px-4 py-3 flex items-center justify-between hover:bg-gray-100 transition-colors">
              ...
              <span className="text-[#5CE0D2] text-lg font-bold group-open:rotate-45 transition-transform inline-block shrink-0">+</span>
            </summary>
