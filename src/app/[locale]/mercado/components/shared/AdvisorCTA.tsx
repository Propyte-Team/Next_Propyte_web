    ...
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
      <div className="bg-propyte-cyan-100 border-2 border-propyte-brand rounded-xl p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <a
          ...
          className="propyte-cta-whatsapp inline-flex items-center gap-2 px-6 py-3 font-semibold rounded-xl transition-colors shadow-lg shadow-[var(--propyte-dark-900)]/20 whitespace-nowrap"
        >
