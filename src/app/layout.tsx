    ...
    >
      <head>
        {/* WebMCP origin trial (propyte.com + subdominios). Habilita
            ...
            ⚠️ Con el trial activo, dos <form> con el mismo `toolname` en la
            misma página tumban el renderer (RESULT_CODE_KILLED_BAD_MESSAGE).
            No repetir toolname: usar `registerTool={false}` en copias móvil/
            desktop del mismo form (ver BlogSidebarForm). */}
        <meta
