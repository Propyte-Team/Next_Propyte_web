...
// ============================================================
//
// ORIGEN: Copiado de propyte-crm/src/lib/zoho/types.ts (commit base 2026-04-02).
// Mantenemos parity con ese archivo hasta que alguno divergir requiera distinto.
...
// --- Sync Engine Types (no usados desde web, mantenidos por parity con propyte-crm) ---
